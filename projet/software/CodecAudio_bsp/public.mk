...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../CodecAudio.sopcinfo
...
# Design Name 
# setting SOPC_NAME is CodecAudio
SOPC_NAME := CodecAudio
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x81090
SOPC_SYSID_FLAG += --sidp=0x81090
ELF_PATCH_FLAG  += --sidp 0x81090

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1500225394
SOPC_SYSID_FLAG += --timestamp=1500225394
ELF_PATCH_FLAG  += --timestamp 1500225394
