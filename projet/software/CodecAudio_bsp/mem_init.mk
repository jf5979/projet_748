...
# Memory: onchipmem
MEM_0 := CodecAudio_onchipmem
$(MEM_0)_NAME := onchipmem
...
$(MEM_0)_HIERARCHICAL_PATH := onchipmem
$(MEM_0)_WIDTH := 32
...
.PHONY: onchipmem
onchipmem: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
