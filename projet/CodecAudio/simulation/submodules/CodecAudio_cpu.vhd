...
entity CodecAudio_cpu is
	port (
		clk                                 : in  std_logic                     := '0';             --                       clk.clk
		reset_n                             : in  std_logic                     := '0';             --                     reset.reset_n
		reset_req                           : in  std_logic                     := '0';             --                          .reset_req
		d_address                           : out std_logic_vector(19 downto 0);                    --               data_master.address
		...
		i_address                           : out std_logic_vector(19 downto 0);                    --        instruction_master.address
...
end entity CodecAudio_cpu;

architecture rtl of CodecAudio_cpu is
	component CodecAudio_cpu_cpu is
		port (
	...
	end component CodecAudio_cpu_cpu;

begin

	cpu : component CodecAudio_cpu_cpu
		port map (
			clk                                 => clk,                                 --                       clk.clk
...
end architecture rtl; -- of CodecAudio_cpu
