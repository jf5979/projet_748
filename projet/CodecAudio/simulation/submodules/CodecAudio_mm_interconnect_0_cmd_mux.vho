...
--synthesis_resources = 
 ...
 ENTITY  CodecAudio_mm_interconnect_0_cmd_mux IS 
	 PORT 
	 ( 
		 clk	:	IN  STD_LOGIC;
		 reset	:	IN  STD_LOGIC;
 ...
 END CodecAudio_mm_interconnect_0_cmd_mux;

 ARCHITECTURE RTL OF CodecAudio_mm_interconnect_0_cmd_mux IS
 ...
 BEGIN
	...
	src_channel <= ( sink0_channel(11 DOWNTO 0));
	src_data <= ( sink0_data(97 DOWNTO 0));
	src_endofpacket <= sink0_endofpacket;
	src_startofpacket <= sink0_startofpacket;
	src_valid <= sink0_valid;

 END RTL; --CodecAudio_mm_interconnect_0_cmd_mux
