//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" LPM_PIPELINE=3 LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=24 LPM_WIDTHB=24 LPM_WIDTHP=48 LPM_WIDTHS=48 MAXIMIZE_SPEED=7 clken clock dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
`endif
	...
	wire signed	[23:0]    datab_wire;
	wire signed	[47:0]    result_wire;
	...
	// synopsys translate_on
	always @(posedge clock)
		 if (clken == 1'b1)	result_extra0_reg <= result_wire[47:0];
