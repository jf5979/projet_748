...
--synthesis_resources = altsyncram 3 lpm_add_sub 5 lpm_counter 1 lpm_mult 2 lut 334 mux21 588 oper_add 3 
 LIBRARY ieee;
 ...
 ARCHITECTURE RTL OF sine_nco_ii_0 IS
	 ...
	 SIGNAL  wire_ni000i26_w_lg_w_lg_q1053w1054w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_ni000i26_w_lg_q1053w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL	 ni000l23	:	STD_LOGIC := '0';
	 SIGNAL	 ni000l24	:	STD_LOGIC := '0';
	 SIGNAL  wire_ni000l24_w_lg_w_lg_q1046w1047w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_ni000l24_w_lg_q1046w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL	 ni000O21	:	STD_LOGIC := '0';
	 SIGNAL	 ni000O22	:	STD_LOGIC := '0';
	 SIGNAL  wire_ni000O22_w_lg_w_lg_q1026w1027w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_ni000O22_w_lg_q1026w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL	 ni001i31	:	STD_LOGIC := '0';
	 SIGNAL	 ni001i32	:	STD_LOGIC := '0';
	 SIGNAL  wire_ni001i32_w_lg_w_lg_q1083w1084w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_ni001i32_w_lg_q1083w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL	 ni001l29	:	STD_LOGIC := '0';
	 SIGNAL	 ni001l30	:	STD_LOGIC := '0';
	 SIGNAL  wire_ni001l30_w_lg_w_lg_q1060w1061w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_ni001l30_w_lg_q1060w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL	 ni001O27	:	STD_LOGIC := '0';
	 SIGNAL	 ni001O28	:	STD_LOGIC := '0';
	 SIGNAL  wire_ni001O28_w_lg_w_lg_q1057w1058w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_ni001O28_w_lg_q1057w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL	 ni00ii19	:	STD_LOGIC := '0';
	 SIGNAL	 ni00ii20	:	STD_LOGIC := '0';
	 SIGNAL  wire_ni00ii20_w_lg_w_lg_q1017w1018w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_ni00ii20_w_lg_q1017w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL	 ni00il17	:	STD_LOGIC := '0';
	 SIGNAL	 ni00il18	:	STD_LOGIC := '0';
	 SIGNAL  wire_ni00il18_w_lg_w_lg_q999w1000w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_ni00il18_w_lg_q999w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL	 ni00iO15	:	STD_LOGIC := '0';
	 SIGNAL	 ni00iO16	:	STD_LOGIC := '0';
	 SIGNAL  wire_ni00iO16_w_lg_w_lg_q993w994w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_ni00iO16_w_lg_q993w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL	 ni00li13	:	STD_LOGIC := '0';
	 SIGNAL	 ni00li14	:	STD_LOGIC := '0';
	 SIGNAL  wire_ni00li14_w_lg_w_lg_q884w885w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_ni00li14_w_lg_q884w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL	 ni00ll11	:	STD_LOGIC := '0';
	 SIGNAL	 ni00ll12	:	STD_LOGIC := '0';
	 SIGNAL  wire_ni00ll12_w_lg_w_lg_q880w881w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_ni00ll12_w_lg_q880w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL	 ni00lO10	:	STD_LOGIC := '0';
	 SIGNAL  wire_ni00lO10_w_lg_w_lg_q876w877w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_ni00lO10_w_lg_q876w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL	 ni00lO9	:	STD_LOGIC := '0';
	 SIGNAL	 ni00Oi7	:	STD_LOGIC := '0';
	 SIGNAL	 ni00Oi8	:	STD_LOGIC := '0';
	 SIGNAL	 ni01li39	:	STD_LOGIC := '0';
	 SIGNAL	 ni01li40	:	STD_LOGIC := '0';
	 SIGNAL	 ni01lO37	:	STD_LOGIC := '0';
	 SIGNAL	 ni01lO38	:	STD_LOGIC := '0';
	 SIGNAL	 ni01Ol35	:	STD_LOGIC := '0';
	 SIGNAL	 ni01Ol36	:	STD_LOGIC := '0';
	 SIGNAL  wire_ni01Ol36_w_lg_w_lg_q1092w1093w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_ni01Ol36_w_lg_q1092w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL	 ni01OO33	:	STD_LOGIC := '0';
	 SIGNAL	 ni01OO34	:	STD_LOGIC := '0';
	 SIGNAL  wire_ni01OO34_w_lg_w_lg_q1087w1088w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_ni01OO34_w_lg_q1087w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL	 ni0i1i5	:	STD_LOGIC := '0';
	 SIGNAL	 ni0i1i6	:	STD_LOGIC := '0';
	 SIGNAL	 ni0i1O3	:	STD_LOGIC := '0';
	 SIGNAL	 ni0i1O4	:	STD_LOGIC := '0';
	 SIGNAL  wire_ni0i1O4_w_lg_q83w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 ...
	 SIGNAL  wire_nlill_w_lg_nii0l168w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 ...
	 SIGNAL  wire_ni0ili_w_result_range992w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_ni0ili_w_result_range998w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_ni0ili_w_result_range1016w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_ni0ili_w_result_range1025w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_nii1O_cin	:	STD_LOGIC;
	 SIGNAL  wire_nlill_w_lg_nilOi169w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 ...
	 SIGNAL  wire_niOOOi_w_result_range875w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_niOOOi_w_result_range879w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_niOOOi_w_result_range883w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 ...
	 SIGNAL  wire_nli0O_w_lg_w_lg_w_lg_w_lg_w_q_range74w76w78w81w84w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_nli0O_w_lg_w_lg_w_lg_w_q_range74w76w78w81w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_nli0O_w_lg_w_lg_w_q_range74w76w78w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_nli0O_w_lg_w_q_range74w76w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_nli0O_w_lg_w_q_range79w80w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_nli0O_q	:	STD_LOGIC_VECTOR (3 DOWNTO 0);
	 SIGNAL  wire_nli0O_sclr	:	STD_LOGIC;
	 SIGNAL  wire_nli0O_w_q_range79w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_nli0O_w_q_range74w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_nli0O_w_q_range75w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_nli0O_w_q_range77w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 ...
	 SIGNAL  wire_w_lg_clken85w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_w_lg_ni00OO90w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL  wire_w_lg_reset_n89w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
 ...
 BEGIN
	...
	wire_gnd <= '0';
	wire_vcc <= '1';
	wire_w_lg_clken85w(0) <= clken AND wire_nli0O_w_lg_w_lg_w_lg_w_lg_w_q_range74w76w78w81w84w(0);
	wire_w_lg_ni00OO90w(0) <= NOT ni00OO;
	wire_w_lg_reset_n89w(0) <= NOT reset_n;
	fsin_o <= ( wire_nii1O_result(23 DOWNTO 0));
	ni00OO <= ((((((((((((((((((((((((((NOT wire_nlliOl_result(23)) AND (NOT wire_nlliOl_result(24))) AND (NOT wire_nlliOl_result(25))) AND (NOT wire_nlliOl_result(26))) AND (NOT wire_nlliOl_result(27))) AND (NOT wire_nlliOl_result(28))) AND (NOT wire_nlliOl_result(29))) AND (NOT wire_nlliOl_result(30))) AND (NOT wire_nlliOl_result(31))) AND (NOT wire_nlliOl_result(32))) AND (NOT wire_nlliOl_result(33))) AND (NOT wire_nlliOl_result(34))) AND (NOT wire_nlliOl_result(35))) AND (NOT wire_nlliOl_result(36))) AND (NOT wire_nlliOl_result(37))) AND (NOT wire_nlliOl_result(38))) AND (NOT wire_nlliOl_result(39))) AND (NOT wire_nlliOl_result(40))) AND (NOT wire_nlliOl_result(41))) AND (NOT wire_nlliOl_result(42))) AND (NOT wire_nlliOl_result(43))) AND (NOT wire_nlliOl_result(44))) AND (NOT wire_nlliOl_result(45))) AND (NOT wire_nlliOl_result(46))) AND (NOT wire_nlliOl_result(47))) AND (ni00Oi8 XOR ni00Oi7));
	ni0i0O <= '1';
	out_valid <= nlilO;
	...
	BEGIN
		...
		END IF;
	END PROCESS;
	wire_ni000i26_w_lg_w_lg_q1053w1054w(0) <= wire_ni000i26_w_lg_q1053w(0) AND nil11O;
	wire_ni000i26_w_lg_q1053w(0) <= ni000i26 XOR ni000i25;
	PROCESS (clk)
	BEGIN
	...
	BEGIN
		...
		END IF;
	END PROCESS;
	wire_ni000l24_w_lg_w_lg_q1046w1047w(0) <= wire_ni000l24_w_lg_q1046w(0) AND nil11O;
	wire_ni000l24_w_lg_q1046w(0) <= ni000l24 XOR ni000l23;
	PROCESS (clk)
	BEGIN
	...
	BEGIN
		...
		END IF;
	END PROCESS;
	wire_ni000O22_w_lg_w_lg_q1026w1027w(0) <= wire_ni000O22_w_lg_q1026w(0) AND wire_ni0ili_w_result_range1025w(0);
	wire_ni000O22_w_lg_q1026w(0) <= ni000O22 XOR ni000O21;
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni001i31 <= ni001i32;
		END IF;
		if (now = 0 ns) then
			ni001i31 <= '1' after 1 ps;
		end if;
	END PROCESS;
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni001i32 <= ni001i31;
		END IF;
	END PROCESS;
	wire_ni001i32_w_lg_w_lg_q1083w1084w(0) <= wire_ni001i32_w_lg_q1083w(0) AND niiO0l;
	wire_ni001i32_w_lg_q1083w(0) <= ni001i32 XOR ni001i31;
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni001l29 <= ni001l30;
		END IF;
		if (now = 0 ns) then
			ni001l29 <= '1' after 1 ps;
		end if;
	END PROCESS;
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni001l30 <= ni001l29;
		END IF;
	END PROCESS;
	wire_ni001l30_w_lg_w_lg_q1060w1061w(0) <= wire_ni001l30_w_lg_q1060w(0) AND nil11O;
	wire_ni001l30_w_lg_q1060w(0) <= ni001l30 XOR ni001l29;
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni001O27 <= ni001O28;
		END IF;
		if (now = 0 ns) then
			ni001O27 <= '1' after 1 ps;
		end if;
	END PROCESS;
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni001O28 <= ni001O27;
		END IF;
	END PROCESS;
	wire_ni001O28_w_lg_w_lg_q1057w1058w(0) <= wire_ni001O28_w_lg_q1057w(0) AND nil11O;
	wire_ni001O28_w_lg_q1057w(0) <= ni001O28 XOR ni001O27;
	PROCESS (clk)
	BEGIN
	...
	BEGIN
		...
		END IF;
	END PROCESS;
	wire_ni00ii20_w_lg_w_lg_q1017w1018w(0) <= wire_ni00ii20_w_lg_q1017w(0) AND wire_ni0ili_w_result_range1016w(0);
	wire_ni00ii20_w_lg_q1017w(0) <= ni00ii20 XOR ni00ii19;
	PROCESS (clk)
	BEGIN
	...
	BEGIN
		...
		END IF;
	END PROCESS;
	wire_ni00il18_w_lg_w_lg_q999w1000w(0) <= wire_ni00il18_w_lg_q999w(0) AND wire_ni0ili_w_result_range998w(0);
	wire_ni00il18_w_lg_q999w(0) <= ni00il18 XOR ni00il17;
	PROCESS (clk)
	BEGIN
	...
	BEGIN
		...
		END IF;
	END PROCESS;
	wire_ni00iO16_w_lg_w_lg_q993w994w(0) <= wire_ni00iO16_w_lg_q993w(0) AND wire_ni0ili_w_result_range992w(0);
	wire_ni00iO16_w_lg_q993w(0) <= ni00iO16 XOR ni00iO15;
	PROCESS (clk)
	BEGIN
	...
	BEGIN
		...
		END IF;
	END PROCESS;
	wire_ni00li14_w_lg_w_lg_q884w885w(0) <= wire_ni00li14_w_lg_q884w(0) AND wire_niOOOi_w_result_range883w(0);
	wire_ni00li14_w_lg_q884w(0) <= ni00li14 XOR ni00li13;
	PROCESS (clk)
	BEGIN
	...
	BEGIN
		...
		END IF;
	END PROCESS;
	wire_ni00ll12_w_lg_w_lg_q880w881w(0) <= wire_ni00ll12_w_lg_q880w(0) AND wire_niOOOi_w_result_range879w(0);
	wire_ni00ll12_w_lg_q880w(0) <= ni00ll12 XOR ni00ll11;
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni00lO10 <= ni00lO9;
		END IF;
	END PROCESS;
	wire_ni00lO10_w_lg_w_lg_q876w877w(0) <= wire_ni00lO10_w_lg_q876w(0) AND wire_niOOOi_w_result_range875w(0);
	wire_ni00lO10_w_lg_q876w(0) <= ni00lO10 XOR ni00lO9;
	PROCESS (clk)
	BEGIN
	...
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni00Oi7 <= ni00Oi8;
		END IF;
		if (now = 0 ns) then
			ni00Oi7 <= '1' after 1 ps;
		end if;
	END PROCESS;
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni00Oi8 <= ni00Oi7;
		END IF;
	END PROCESS;
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni01li39 <= ni01li40;
		END IF;
		if (now = 0 ns) then
			ni01li39 <= '1' after 1 ps;
		end if;
	END PROCESS;
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni01li40 <= ni01li39;
		END IF;
	END PROCESS;
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni01lO37 <= ni01lO38;
		END IF;
		if (now = 0 ns) then
			ni01lO37 <= '1' after 1 ps;
		end if;
	END PROCESS;
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni01lO38 <= ni01lO37;
		END IF;
	END PROCESS;
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni01Ol35 <= ni01Ol36;
		END IF;
		if (now = 0 ns) then
			ni01Ol35 <= '1' after 1 ps;
		end if;
	END PROCESS;
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni01Ol36 <= ni01Ol35;
		END IF;
	END PROCESS;
	wire_ni01Ol36_w_lg_w_lg_q1092w1093w(0) <= wire_ni01Ol36_w_lg_q1092w(0) AND niiO1l;
	wire_ni01Ol36_w_lg_q1092w(0) <= ni01Ol36 XOR ni01Ol35;
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni01OO33 <= ni01OO34;
		END IF;
		if (now = 0 ns) then
			ni01OO33 <= '1' after 1 ps;
		end if;
	END PROCESS;
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni01OO34 <= ni01OO33;
		END IF;
	END PROCESS;
	wire_ni01OO34_w_lg_w_lg_q1087w1088w(0) <= wire_ni01OO34_w_lg_q1087w(0) AND niiO0i;
	wire_ni01OO34_w_lg_q1087w(0) <= ni01OO34 XOR ni01OO33;
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni0i1i5 <= ni0i1i6;
		END IF;
		if (now = 0 ns) then
			ni0i1i5 <= '1' after 1 ps;
		end if;
	END PROCESS;
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni0i1i6 <= ni0i1i5;
		END IF;
	END PROCESS;
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni0i1O3 <= ni0i1O4;
		END IF;
		if (now = 0 ns) then
			ni0i1O3 <= '1' after 1 ps;
		end if;
	END PROCESS;
	PROCESS (clk)
	BEGIN
		IF (clk = '1' AND clk'event) THEN ni0i1O4 <= ni0i1O3;
		END IF;
	END PROCESS;
	wire_ni0i1O4_w_lg_q83w(0) <= ni0i1O4 XOR ni0i1O3;
	PROCESS (clk)
	BEGIN
	...
	wire_nlill_w_lg_nii0l168w(0) <= NOT nii0l;
	wire_ni0iiO_aclr <= wire_w_lg_reset_n89w(0);
	...
	wire_ni0ili_aclr <= wire_w_lg_reset_n89w(0);
	...
	wire_ni0ili_w_result_range992w(0) <= wire_ni0ili_result(17);
	wire_ni0ili_w_result_range998w(0) <= wire_ni0ili_result(19);
	wire_ni0ili_w_result_range1016w(0) <= wire_ni0ili_result(25);
	wire_ni0ili_w_result_range1025w(0) <= wire_ni0ili_result(28);
	ni0ili :  lpm_add_sub
	  GENERIC MAP (
		LPM_DIRECTION => "ADD",
		LPM_PIPELINE => 1,
	...
	wire_nii1O_cin <= wire_nlill_w_lg_nilOi169w(0);
	wire_nlill_w_lg_nilOi169w(0) <= nilOi AND wire_nlill_w_lg_nii0l168w(0);
	...
	wire_niOOOi_aclr <= wire_w_lg_reset_n89w(0);
	...
	wire_niOOOi_w_result_range875w(0) <= wire_niOOOi_result(13);
	wire_niOOOi_w_result_range879w(0) <= wire_niOOOi_result(14);
	wire_niOOOi_w_result_range883w(0) <= wire_niOOOi_result(15);
	niOOOi :  lpm_add_sub
	  GENERIC MAP (
		LPM_PIPELINE => 1,
		LPM_REPRESENTATION => "SIGNED",
	...
	wire_nli0O_w_lg_w_lg_w_lg_w_lg_w_q_range74w76w78w81w84w(0) <= wire_nli0O_w_lg_w_lg_w_lg_w_q_range74w76w78w81w(0) AND wire_ni0i1O4_w_lg_q83w(0);
	wire_nli0O_w_lg_w_lg_w_lg_w_q_range74w76w78w81w(0) <= wire_nli0O_w_lg_w_lg_w_q_range74w76w78w(0) AND wire_nli0O_w_lg_w_q_range79w80w(0);
	wire_nli0O_w_lg_w_lg_w_q_range74w76w78w(0) <= wire_nli0O_w_lg_w_q_range74w76w(0) AND wire_nli0O_w_q_range77w(0);
	wire_nli0O_w_lg_w_q_range74w76w(0) <= wire_nli0O_w_q_range74w(0) AND wire_nli0O_w_q_range75w(0);
	wire_nli0O_w_lg_w_q_range79w80w(0) <= NOT wire_nli0O_w_q_range79w(0);
	wire_nli0O_sclr <= wire_w_lg_reset_n89w(0);
	wire_nli0O_w_q_range79w(0) <= wire_nli0O_q(0);
	wire_nli0O_w_q_range74w(0) <= wire_nli0O_q(1);
	wire_nli0O_w_q_range75w(0) <= wire_nli0O_q(2);
	wire_nli0O_w_q_range77w(0) <= wire_nli0O_q(3);
	nli0O :  lpm_counter
	  GENERIC MAP (
		LPM_DIRECTION => "UP",
		LPM_MODULUS => 0,
	...
	wire_n010i_dataout <= wire_ni0li_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n010l_dataout <= wire_ni0ll_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n010O_dataout <= wire_ni0lO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n011i_dataout <= wire_ni0ii_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n011l_dataout <= wire_ni0il_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n011O_dataout <= wire_ni0iO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n01ii_dataout <= wire_ni0Oi_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n01il_dataout <= wire_ni0Ol_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n01iO_dataout <= wire_ni0OO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n01li_dataout <= wire_nii1i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_n100i_dataout <= wire_n0ili_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n100l_dataout <= wire_n0ill_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n100O_dataout <= wire_n0ilO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n101i_dataout <= wire_n0iii_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n101l_dataout <= wire_n0iil_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n101O_dataout <= wire_n0iiO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n10ii_dataout <= wire_n0iOi_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n10il_dataout <= wire_n0iOl_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n10iO_dataout <= wire_n0iOO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n10li_dataout <= wire_n0l1i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n10ll_dataout <= wire_n0l1l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n10lO_dataout <= wire_n0l1O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n10Oi_dataout <= wire_n0l0i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n10Ol_dataout <= wire_n0l0l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n10OO_dataout <= wire_n0l0O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n110i_dataout <= wire_n00li_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n110l_dataout <= wire_n00ll_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n110O_dataout <= wire_n00lO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n111i_dataout <= wire_n00ii_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n111l_dataout <= wire_n00il_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n111O_dataout <= wire_n00iO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n11ii_dataout <= wire_n00Oi_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n11il_dataout <= wire_n00Ol_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n11iO_dataout <= wire_n00OO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n11li_dataout <= wire_n0i1i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n11ll_dataout <= wire_n0i1l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n11lO_dataout <= wire_n0i1O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n11Oi_dataout <= wire_n0i0i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n11Ol_dataout <= wire_n0i0l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n11OO_dataout <= wire_n0i0O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1i0i_dataout <= wire_n0lli_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1i0l_dataout <= wire_n0lll_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1i0O_dataout <= wire_n0llO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1i1i_dataout <= wire_n0lii_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1i1l_dataout <= wire_n0lil_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1i1O_dataout <= wire_n0liO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1iii_dataout <= wire_n0lOi_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1iil_dataout <= wire_n0lOl_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1iiO_dataout <= wire_n0lOO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1ili_dataout <= wire_n0O1i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1ill_dataout <= wire_n0O1l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1ilO_dataout <= wire_n0O1O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1iOi_dataout <= wire_n0O0i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1iOl_dataout <= wire_n0O0l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1iOO_dataout <= wire_n0O0O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1l0i_dataout <= wire_n0Oli_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1l0l_dataout <= wire_n0Oll_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1l0O_dataout <= wire_n0OlO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1l1i_dataout <= wire_n0Oii_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1l1l_dataout <= wire_n0Oil_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1l1O_dataout <= wire_n0OiO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1lii_dataout <= wire_n0OOi_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1lil_dataout <= wire_n0OOl_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1liO_dataout <= wire_n0OOO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1lli_dataout <= wire_ni11i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1lll_dataout <= wire_ni11l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1llO_dataout <= wire_ni11O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1lOi_dataout <= wire_ni10i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1lOl_dataout <= wire_ni10l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1lOO_dataout <= wire_ni10O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1O0i_dataout <= wire_ni1li_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1O0l_dataout <= wire_ni1ll_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1O0O_dataout <= wire_ni1lO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1O1i_dataout <= wire_ni1ii_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1O1l_dataout <= wire_ni1il_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1O1O_dataout <= wire_ni1iO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1Oii_dataout <= wire_ni1Oi_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1Oil_dataout <= wire_ni1Ol_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1OiO_dataout <= wire_ni1OO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1Oli_dataout <= wire_ni01i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1Oll_dataout <= wire_ni01l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1OlO_dataout <= wire_ni01O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1OOi_dataout <= wire_ni00i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1OOl_dataout <= wire_ni00l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_n1OOO_dataout <= wire_ni00O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_ni0OlO_dataout <= wire_nii0Ol_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_ni0OO_dataout <= wire_nllilO_result(46) WHEN clken = '1'  ELSE nlll1i;
	wire_ni0OOi_dataout <= wire_nii0OO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_ni0OOl_dataout <= wire_niii1i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_ni0OOO_dataout <= wire_niii1l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_nii00i_dataout <= wire_niil0O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii00l_dataout <= wire_niilii_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii00O_dataout <= wire_niilil_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii01i_dataout <= wire_niil1O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii01l_dataout <= wire_niil0i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii01O_dataout <= wire_niil0l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii0ii_dataout <= wire_niiliO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii0il_dataout <= wire_niilli_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii0iO_dataout <= wire_niilll_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii0li_dataout <= wire_niillO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii0ll_dataout <= wire_niilOi_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii0lO_dataout <= wire_niilOl_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii0Oi_dataout <= wire_niilOO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_nii10i_dataout <= wire_niii0O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii10l_dataout <= wire_niiiii_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii10O_dataout <= wire_niiiil_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii11i_dataout <= wire_niii1O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii11l_dataout <= wire_niii0i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii11O_dataout <= wire_niii0l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii1i_dataout <= wire_nllilO_result(47) WHEN clken = '1'  ELSE nlliOO;
	wire_nii1ii_dataout <= wire_niiiiO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii1il_dataout <= wire_niiili_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii1iO_dataout <= wire_niiill_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii1li_dataout <= wire_niiilO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii1ll_dataout <= wire_niiiOi_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii1lO_dataout <= wire_niiiOl_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii1Oi_dataout <= wire_niiiOO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii1Ol_dataout <= wire_niil1i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nii1OO_dataout <= wire_niil1l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_nil00i_dataout <= wire_niliiO_dataout OR wire_w_lg_reset_n89w(0);
	wire_nil00l_dataout <= wire_nilili_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nil00O_dataout <= wire_nilill_dataout OR wire_w_lg_reset_n89w(0);
	wire_nil01i_dataout <= wire_nili0O_dataout OR wire_w_lg_reset_n89w(0);
	wire_nil01l_dataout <= wire_niliii_dataout OR wire_w_lg_reset_n89w(0);
	wire_nil01O_dataout <= wire_niliil_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nil0ii_dataout <= wire_nililO_dataout OR wire_w_lg_reset_n89w(0);
	wire_nil0il_dataout <= wire_niliOi_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nil0iO_dataout <= wire_niliOl_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nil0li_dataout <= wire_niliOO_dataout OR wire_w_lg_reset_n89w(0);
	...
	wire_nil0OO_dataout <= (((niiO1O XOR niiO1l) XOR (NOT (ni01lO38 XOR ni01lO37))) XOR ((niiOOl XOR niiO0l) XOR (NOT (ni01li40 XOR ni01li39)))) WHEN clken = '1'  ELSE nil11l;
	wire_nil10O_dataout <= wire_nil0ll_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nil1ii_dataout <= wire_nil0lO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nil1il_dataout <= wire_nil0Oi_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nil1iO_dataout <= wire_nil0Ol_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nil1li_dataout <= wire_nil0OO_dataout OR wire_w_lg_reset_n89w(0);
	wire_nil1ll_dataout <= wire_nili1i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nil1lO_dataout <= wire_nili1l_dataout OR wire_w_lg_reset_n89w(0);
	wire_nil1Oi_dataout <= wire_nili1O_dataout OR wire_w_lg_reset_n89w(0);
	wire_nil1Ol_dataout <= wire_nili0i_dataout OR wire_w_lg_reset_n89w(0);
	wire_nil1OO_dataout <= wire_nili0l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_nilOl_dataout <= wire_nl1il_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nilOO_dataout <= wire_nl1iO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niO00i_dataout <= wire_niOi0l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niO00l_dataout <= wire_niOi0O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niO00O_dataout <= wire_niOiii_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niO01i_dataout <= wire_niOi1l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niO01l_dataout <= wire_niOi1O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niO01O_dataout <= wire_niOi0i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niO0i_dataout <= wire_nl1Oi_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niO0ii_dataout <= wire_niOiil_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niO0il_dataout <= wire_niOiiO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niO0iO_dataout <= nilO0O WHEN clken = '1'  ELSE niO1ii;
	wire_niO0l_dataout <= wire_nl1Ol_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_niO0O_dataout <= wire_nl1OO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_niO1i_dataout <= wire_nl1li_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niO1il_dataout <= wire_niO0iO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niO1iO_dataout <= wire_niO0li_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niO1l_dataout <= wire_nl1ll_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niO1li_dataout <= wire_niO0ll_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niO1ll_dataout <= wire_niO0lO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niO1lO_dataout <= wire_niO0Oi_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niO1O_dataout <= wire_nl1lO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niO1Oi_dataout <= wire_niO0Ol_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niO1Ol_dataout <= wire_niO0OO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niO1OO_dataout <= wire_niOi1i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_niOii_dataout <= wire_nl01i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_niOil_dataout <= wire_nl01l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niOili_dataout <= wire_niOlll_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niOill_dataout <= wire_niOllO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niOilO_dataout <= wire_niOlOi_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niOiO_dataout <= wire_nl01O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niOiOi_dataout <= wire_niOlOl_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niOiOl_dataout <= wire_niOlOO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niOiOO_dataout <= wire_niOO1i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niOl0i_dataout <= wire_niOO0l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niOl0l_dataout <= wire_niOO0O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niOl0O_dataout <= wire_niOOii_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niOl1i_dataout <= wire_niOO1l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niOl1l_dataout <= wire_niOO1O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niOl1O_dataout <= wire_niOO0i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niOli_dataout <= wire_nl00i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niOlii_dataout <= wire_niOOil_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niOlil_dataout <= wire_niOOiO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niOliO_dataout <= wire_niOOli_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niOll_dataout <= wire_nl00l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niOlli_dataout <= wire_niOOll_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_niOlll_dataout <= wire_niOOlO_o(5) WHEN clken = '1'  ELSE nilO0O;
	wire_niOllO_dataout <= wire_niOOlO_o(6) WHEN clken = '1'  ELSE nilO0l;
	wire_niOlO_dataout <= wire_nl00O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_niOOi_dataout <= wire_nl0ii_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_niOOl_dataout <= wire_nl0il_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_niOOO_dataout <= wire_nl0iO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl000i_dataout <= wire_nl0i0l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl000l_dataout <= wire_nl0i0O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl000O_dataout <= wire_nl0iii_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl001l_dataout <= wire_nl0i1O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl001O_dataout <= wire_nl0i0i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl00i_dataout <= wire_nlliOl_result(34) WHEN clken = '1'  ELSE nil1l;
	wire_nl00ii_dataout <= wire_nl0iil_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl00il_dataout <= wire_nl0iiO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl00iO_dataout <= wire_nl0ili_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl00l_dataout <= wire_nlliOl_result(35) WHEN clken = '1'  ELSE nil1i;
	wire_nl00li_dataout <= wire_nl0ill_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl00ll_dataout <= wire_nl0ilO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl00lO_dataout <= wire_nl0iOi_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl00O_dataout <= wire_nlliOl_result(36) WHEN clken = '1'  ELSE niiOO;
	wire_nl00Oi_dataout <= wire_nl0iOl_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl00Ol_dataout <= wire_nl0iOO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl00OO_dataout <= wire_nl0l1i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_nl0i1i_dataout <= wire_nl0l1l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl0i1l_dataout <= wire_nl0l1O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_nl0l0O_dataout <= wire_nl0Oii_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_nl0lii_dataout <= wire_nl0Oil_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl0lil_dataout <= wire_nl0OiO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl0liO_dataout <= wire_nl0Oli_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl0ll_dataout <= wire_nlliOl_result(41) WHEN clken = '1'  ELSE niili;
	wire_nl0lli_dataout <= wire_nl0Oll_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl0lll_dataout <= wire_nl0OlO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl0llO_dataout <= wire_nl0OOi_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl0lO_dataout <= wire_nlliOl_result(42) WHEN clken = '1'  ELSE niiiO;
	wire_nl0lOi_dataout <= wire_nl0OOl_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl0lOl_dataout <= wire_nl0OOO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl0lOO_dataout <= wire_nli11i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl0O0i_dataout <= wire_nli10l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl0O0l_dataout <= wire_nli10O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl0O0O_dataout <= wire_nli1ii_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl0O1i_dataout <= wire_nli11l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl0O1l_dataout <= wire_nli11O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl0O1O_dataout <= wire_nli10i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_nl10i_dataout <= wire_nl0Oi_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl10l_dataout <= wire_nl0Ol_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl10O_dataout <= wire_nl0OO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl11i_dataout <= wire_nl0li_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl11l_dataout <= wire_nl0ll_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl11O_dataout <= wire_nl0lO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl1ii_dataout <= wire_nli1i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_nl1lOl_dataout <= wire_nl1OOO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl1lOO_dataout <= wire_nl011i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl1O0i_dataout <= wire_nl010l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl1O0l_dataout <= wire_nl010O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl1O0O_dataout <= wire_nl01ii_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl1O1i_dataout <= wire_nl011l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl1O1l_dataout <= wire_nl011O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl1O1O_dataout <= wire_nl010i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl1Oi_dataout <= wire_nlliOl_result(28) WHEN clken = '1'  ELSE nilil;
	wire_nl1Oii_dataout <= wire_nl01il_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl1Oil_dataout <= wire_nl01iO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl1OiO_dataout <= wire_nl01li_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl1Ol_dataout <= wire_nlliOl_result(29) WHEN clken = '1'  ELSE nilii;
	wire_nl1Oli_dataout <= wire_nl01ll_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl1Oll_dataout <= wire_nl01lO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl1OlO_dataout <= wire_nl01Oi_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl1OO_dataout <= wire_nlliOl_result(30) WHEN clken = '1'  ELSE nil0O;
	wire_nl1OOi_dataout <= wire_nl01Ol_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl1OOl_dataout <= wire_nl01OO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nl1OOO_dataout <= phase_mod_i(0) WHEN clken = '1'  ELSE nl0l0i;
	wire_nli00i_dataout <= wire_nlii0l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nli00l_dataout <= wire_nlii0O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nli00O_dataout <= wire_nliiii_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nli01i_dataout <= wire_nlii1l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nli01l_dataout <= wire_nlii1O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nli01O_dataout <= wire_nlii0i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nli0i_dataout <= wire_w_lg_ni00OO90w(0) WHEN clken = '1'  ELSE nilOi;
	wire_nli0ii_dataout <= wire_nliiil_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nli0il_dataout <= wire_nliiiO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_nli1il_dataout <= wire_nli0iO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nli1iO_dataout <= wire_nli0li_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nli1li_dataout <= wire_nli0ll_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nli1ll_dataout <= wire_nli0lO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nli1lO_dataout <= wire_nli0Oi_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nli1O_dataout <= wire_nli0i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nli1Oi_dataout <= wire_nli0Ol_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nli1Ol_dataout <= wire_nli0OO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nli1OO_dataout <= wire_nlii1i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_nliil_dataout <= wire_nliiO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nliiO_dataout <= nlilO OR (wire_w_lg_clken85w(0) AND (ni0i1i6 XOR ni0i1i5));
	wire_nliO0i_dataout <= wire_nll1Ol_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nliO0l_dataout <= wire_nll1OO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nliO0O_dataout <= wire_nll01i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nliOii_dataout <= wire_nll01l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nliOil_dataout <= wire_nll01O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nliOiO_dataout <= wire_nll00i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nliOli_dataout <= wire_nll00l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nliOll_dataout <= wire_nll00O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nliOlO_dataout <= wire_nll0ii_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nliOOi_dataout <= wire_nll0il_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nliOOl_dataout <= wire_nll0iO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nliOOO_dataout <= wire_nll0li_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_nll10i_dataout <= wire_nll0Ol_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nll10O_dataout <= wire_nll0OO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nll11i_dataout <= wire_nll0ll_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nll11l_dataout <= wire_nll0lO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nll11O_dataout <= wire_nll0Oi_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nll1ii_dataout <= wire_nlli1i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nll1il_dataout <= wire_nlli1l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nll1iO_dataout <= wire_nlli1O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nll1li_dataout <= wire_nlli0i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nll1ll_dataout <= wire_nlli0l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nll1lO_dataout <= wire_nlli0O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nll1Oi_dataout <= wire_nlliii_dataout AND NOT(wire_w_lg_reset_n89w(0));
	...
	wire_nlOO0l_dataout <= wire_n01ll_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nlOO0O_dataout <= wire_n01lO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nlOOii_dataout <= wire_n01Oi_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nlOOil_dataout <= wire_n01Ol_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nlOOiO_dataout <= wire_n01OO_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nlOOli_dataout <= wire_n001i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nlOOll_dataout <= wire_n001l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nlOOlO_dataout <= wire_n001O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nlOOOi_dataout <= wire_n000i_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nlOOOl_dataout <= wire_n000l_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nlOOOO_dataout <= wire_n000O_dataout AND NOT(wire_w_lg_reset_n89w(0));
	wire_nill1i_a <= ( niiO1l & niiO1O & wire_ni01OO34_w_lg_w_lg_q1087w1088w & wire_ni001i32_w_lg_w_lg_q1083w1084w);
	wire_nill1i_b <= ( "0" & "0" & "0" & wire_ni01Ol36_w_lg_w_lg_q1092w1093w);
	nill1i :  oper_add
	  GENERIC MAP (
	...
	wire_niOOlO_a <= ( wire_ni0ili_result(31 DOWNTO 29) & wire_ni000O22_w_lg_w_lg_q1026w1027w & wire_ni0ili_result(27 DOWNTO 26) & wire_ni00ii20_w_lg_w_lg_q1017w1018w & wire_ni0ili_result(24 DOWNTO 20) & wire_ni00il18_w_lg_w_lg_q999w1000w & wire_ni0ili_result(18) & wire_ni00iO16_w_lg_w_lg_q993w994w & wire_ni0ili_result(16 DOWNTO 11));
	wire_niOOlO_b <= ( nil11O & nil11O & nil11O & nil11O & wire_ni001l30_w_lg_w_lg_q1060w1061w & wire_ni001O28_w_lg_w_lg_q1057w1058w & nil11O & wire_ni000i26_w_lg_w_lg_q1053w1054w & nil11O & nil11O & nil11O & nil11O & wire_ni000l24_w_lg_w_lg_q1046w1047w & nil11O & nil11O & nil11O & nil11O & nil11O & nil10i & nil10l & nill0l);
	niOOlO :  oper_add
	  GENERIC MAP (
		sgate_representation => 0,
		width_a => 21,
	...
	wire_nlliil_a <= ( "0" & wire_ni00li14_w_lg_w_lg_q884w885w & wire_ni00ll12_w_lg_w_lg_q880w881w & wire_ni00lO10_w_lg_w_lg_q876w877w & wire_niOOOi_result(12 DOWNTO 8));
